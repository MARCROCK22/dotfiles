...
ButtonMouseArea {
    ...
    // Grosor de la pastilla del activo. Con el ancho completo salia un
    // circulo (22x22, radio 11); a 0.42 del boton queda 22x11, que es la
    // pastilla alargada del diseno.
    property real activeWorkspaceThickness: workspaceButtonWidth * 0.42
    ...
    Item {
        ...
        MaskMultiEffect {
            ...
            z: 1
            // Apagado: es el pegote redondo que se pintaba detras de los
            // workspaces ocupados. El diseno pide puntos iguales, y lo
            // ocupado ya se lee por el color del punto (contentColor de
            // NumberWorkspaceItem, colOnSecondaryContainer contra
            // colOnLayer1Inactive).
            visible: false
            anchors.centerIn: parent
        ...
        TrailingIndicator {
            ...
            StateOverlay {
                ...
                anchors.fill: interactionIndicator.indicatorRectangle
                        radius: root.activeWorkspaceThickness / 2
    ...
    component NumberWorkspaceItem: WorkspaceItem {
        ...
        FadeLoader {
            // En el activo el punto sobra: encima se dibuja la pastilla
            // de TrailingIndicator, y el punto quedaba como un agujero
            // oscuro en medio. Los demas si lo llevan, y su color ya
            // distingue ocupado de vacio.
            shown: !wsNum.showingNumbers && wsNum.index !== root.workspaceIndexInGroup
            anchors.centerIn: parent
            Circle {
                anchors.centerIn: parent
    ...
    component TrailingIndicator: Item {
        ...
        StyledRectangle {
            ...
            property real indicatorThickness: root.activeWorkspaceThickness
